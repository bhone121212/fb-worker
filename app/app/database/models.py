...
class Post(Base):
    ...
    fb_link_new = Column('fb_link_new', VARCHAR(1024))
...
class PostStat(Base):
    ...
    like = Column('like', VARCHAR(32))
    love = Column('love', VARCHAR(32))
    haha = Column('haha', VARCHAR(32))
    wow = Column('wow', VARCHAR(32))
    care = Column('care', VARCHAR(32))
    sad = Column('sad', VARCHAR(32))
    angry = Column('angry', VARCHAR(32))
...
class TaskSource(Base):
    ...
    source_type = Column('source_type', VARCHAR(255))
    task_id = Column(Integer, ForeignKey('tasks.id'))
    task = relationship("Task")

class auto_post(Base):
    __tablename__ = 'auto_post'
    id = Column('id', Integer, primary_key=True)   
    text = Column('text', VARCHAR(16384))
    path = Column('path', VARCHAR(1024))
    
class auto_share(Base):
    __tablename__ = 'auto_share'
    id = Column('id', Integer, primary_key=True)   
    text = Column('text', VARCHAR(16384))
    link = Column('link', VARCHAR(1024))
    
class auto_report(Base):
    __tablename__ = 'auto_report'
    id = Column('id', Integer, primary_key=True)    
    link = Column('link', VARCHAR(1024))
    option_1 = Column('option_1', VARCHAR(1024))
    option_2 = Column('option_2', VARCHAR(1024))
    option_3 = Column('option_3', VARCHAR(1024))
...
class automation(Base):
    ...
    auto_post_id = Column('auto_post_id', Integer)
    auto_share_id = Column('auto_share_id', Integer)
    auto_report_id = Column('auto_report_id', Integer)
    date_time = Column('date_time', DateTime)
    auto_post_link = Column('auto_post_link', VARCHAR(1024))
    auto_share_link = Column('auto_share_link', VARCHAR(1024))
...
class WorkerCredential(Base):
    ...
    auto_post_id = Column('auto_post_id', Integer)
    share_id = Column('share_id', Integer)
...
class FBAccount(Base):
    ...
    profile_link = Column('profile_link', VARCHAR(1024))
