...
def parse_source(credentials, browser, task_source):
    ...
    def share_post_to_feed(credentials, browser, auto_share_entry):
        ...
        try:
            ...
            logger.log("Clicked Final Shared")
            sleep(5)
            """try:
